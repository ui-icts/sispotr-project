...
INSERT INTO site_content VALUES ('       <h2>Contributors</h2>
       ...
       and the <a target="_blank" href="http://www.icts.uiowa.edu/">Institute for Clinical and Translational Science</a> 
       at the <a target="_blank" href="http://www.uiowa.edu">University of Iowa</a>
       </p>
          <br/>
       <h2>Help</h2>
       <p>
       For general questions or comments about the site, please email <strong>sispotr@uiowa.edu</strong>
...
SPS (&Delta;G)
    ...
    ', 'resultstable.header', 'tools/sispotr/displayResults.html?type=sirna');
