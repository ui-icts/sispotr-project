...
<h2> ${seqFrag.seqFragId} </h2>
 ...
 Historys: 
 <ul><c:forEach items="${seqFrag.historys}" var="item" varStatus="itemStatus" > <li><a href="../history/edit.html?historyId=${item.historyId}" > ${item.historyId}</a></li> </c:forEach></ul><br/><br/>
